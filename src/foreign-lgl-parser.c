...
yyreduce:
  ...
  switch (yyn)
    {
        case 6:
#line 89 "foreign-lgl-parser.y"
    { igraph_lgl_actvertex=(yyvsp[-1].edgenum); }
    break;

  case 9:
#line 93 "foreign-lgl-parser.y"
    { 
...
/* Line 1126 of yacc.c.  */
#line 1181 "foreign-lgl-parser.c"

  yyvsp -= yylen;
  yyssp -= yylen;
