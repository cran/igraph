...
yyreduce:
  ...
  switch (yyn)
    {
        case 6:
#line 44 "foreign-lgl-parser.y"
    { igraph_lgl_actvertex=(yyvsp[-1].edgenum); }
    break;

  case 9:
#line 48 "foreign-lgl-parser.y"
    { 
             igraph_vector_push_back(igraph_lgl_vector, igraph_lgl_actvertex);
	     igraph_vector_push_back(igraph_lgl_vector, (yyvsp[-1].edgenum));
	     igraph_vector_push_back(igraph_lgl_weights, 0);
           }
    break;

  case 10:
#line 53 "foreign-lgl-parser.y"
    { 
             igraph_vector_push_back(igraph_lgl_vector, igraph_lgl_actvertex);
	     igraph_vector_push_back(igraph_lgl_vector, (yyvsp[-2].edgenum));
	     igraph_vector_push_back(igraph_lgl_weights, (yyvsp[-1].weightnum));
           }
    break;

  case 11:
#line 61 "foreign-lgl-parser.y"
...
/* Line 1037 of yacc.c.  */
#line 1070 "foreign-lgl-parser.c"

  yyvsp -= yylen;
  yyssp -= yylen;
