...
#line 22 "foreign-ncol-parser.y"
typedef union YYSTYPE {
  long int edgenum;
  double weightnum;
} YYSTYPE;
/* Line 190 of yacc.c.  */
#line 114 "foreign-ncol-parser.c"
...
/* Line 213 of yacc.c.  */
#line 126 "foreign-ncol-parser.c"
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 40 "foreign-ncol-parser.y"
    { 
           igraph_vector_push_back(igraph_ncol_vector, (yyvsp[-2].edgenum));
           igraph_vector_push_back(igraph_ncol_vector, (yyvsp[-1].edgenum));
	   igraph_vector_push_back(igraph_ncol_weights, 0);
       }
    break;

  case 6:
#line 45 "foreign-ncol-parser.y"
    { 
           igraph_vector_push_back(igraph_ncol_vector, (yyvsp[-3].edgenum));
           igraph_vector_push_back(igraph_ncol_vector, (yyvsp[-2].edgenum));
	   igraph_vector_push_back(igraph_ncol_weights, (yyvsp[-1].weightnum));
       }
    break;

  case 7:
#line 52 "foreign-ncol-parser.y"
...
/* Line 1037 of yacc.c.  */
#line 1058 "foreign-ncol-parser.c"

  yyvsp -= yylen;
  yyssp -= yylen;
